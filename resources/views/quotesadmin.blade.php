          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Requseted Quotes</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$quotes->id}}</td>
                      <td>{{$quotes->name}}</td>
                      <td><a href="mailto:{{$quotes->email}}">{{$quotes->email}}</a></td>
                      <td>{{$quotes->contact}}</td>
                      <td>{{$quotes->freight}}</td>
                      <td>{{$quotes->departure}}</td>
                      <td>{{$quotes->incoterms}}</td>
                      <td>{{$quotes->weight}}</td>
                      <td>{{$quotes->height}}</td>
                      <td>{{$quotes->width}}</td>
                      <td>{{$quotes->length}}</td>
