...
<main>
    <div class="slider-area ">
        <div class=" d-flex align-items-center" style="background-image:url('assets/img/privatejet/movie.jpg') ;height: 82vh; background-size:100% 100%;">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap">
                            <h2>Movie Promo Tours</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 text-justify">
                    <h1 style="color:#805BA1;">Putting your event centre stage</h1>
                   <p>From airport to red carpet in under an hour. Much like our expertise flying bands on tour, movie promos often involve a quick circuit of a number of cities in a few days for premieres, film festival appearances and awards galas.</p>
                   <p>We’re on hand to help major movie studios, production companies and PR agencies with high-profile projects, involving one or more private jets or coordinating multiple aircraft in different parts of the world simultaneously.</p>
                   <p>Whatever your air charter requirements, our specialist team is at your service.</p>
